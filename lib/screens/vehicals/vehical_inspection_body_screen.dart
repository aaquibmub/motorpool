                    ...
                    child: ImageMap(
                      ...
                      regions: i.parts.map((e) {
                        if (e.part != null) {
                          ...
                          if (e.part.value ==
                              Constants
                                  .vehicalBodyPartFrontSideLeftHeadlightId) {
                            return getImageRegion(
                              e.part,
                              50,
                              160,
                          ...
                          if (e.part.value ==
                              Constants
                                  .vehicalBodyPartFrontSideRightHeadlightId) {
                            return getImageRegion(
                              e.part,
                              400,
                              160,
                          ...
                          if (e.part.value ==
                              Constants
                                  .vehicalBodyPartBackSideLeftTaillightId) {
                            return getImageRegion(
                              e.part,
                              65,
                              140,
                          ...
                          if (e.part.value ==
                              Constants
                                  .vehicalBodyPartBackSideRightTaillightId) {
                            return getImageRegion(
                              e.part,
                              335,
                              140,
